  ...
  return (
    <div className={styles.pageWrapper}>
      <div className={styles.header}>
        <h1 className={styles.title}>Platform Students</h1>
        <p className={styles.subtitle}>View and manage student records and marks</p>
      </div>
...
export default MarksWithoutCollege
