        ...
        {activeTab === "enrolled" && (
          <div>
            ...
            <div className={styles.coursesFlex}>
              <ResumeCourseCard course={enrolledCourses[0]} />
              <ResumeCourseCard course={enrolledCourses[1]} />
              <ResumeCourseCard course={enrolledCourses[2]} />
              <ResumeCourseCard course={enrolledCourses[3]} />
              <ResumeCourseCard course={enrolledCourses[4]} />
            </div>
          </div>
        )}
          ...
          <div>
            ...
            <div className={styles.coursesFlex}>
              {filteredAvailable.length > 0 ? (
                filteredAvailable.map((course, idx) => <CourseCard key={idx} course={course} />)
              ) : (
