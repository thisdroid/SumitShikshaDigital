    ...
    <div className={styles.container}>
      ...
      <div className={styles.header}>
        <h1 className={styles.title}>
          Performance <span className={styles.titleTeal}>Analytics</span>
        </h1>
        <div className={styles.underline}></div>
        <p className={styles.subtitle}>Track and analyze your academic performance across all courses</p>
      </div>
